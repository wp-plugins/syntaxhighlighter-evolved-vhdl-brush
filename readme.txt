...
Adds support for the VHDL and Verilog languages to the SyntaxHighlighter Evolved plugin. Also, includes basic syntax coloring for Xilinx UCF files. An ideal plugin for the FPGA developers out there!
